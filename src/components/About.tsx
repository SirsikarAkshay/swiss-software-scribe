            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="col-span-2">
                <p className="text-muted-foreground leading-relaxed">
                  A Software Engineer with a strong foundation in full-stack development, cloud deployment, and building end-to-end intelligent data-driven systems. My journey began with a degree in Information Science and Engineering from B.V. Bhoomareddy College of Engineering and Technology. I then joined Mercedes-Benz Research and Development India, where I honed my skills in database design, API development, and scalable software solutions.
                </p>
